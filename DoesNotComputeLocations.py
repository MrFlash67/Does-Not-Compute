...
locs = [
Location(0, 'You are in a computer. A banana runs at you', (1,2), 'Starting room', 'Requieres  5 uses of the \'go\' command'),
BlockedLocation(1, 'You are in a computer, north of where you were. There is a wall of fire just in front of you.', (3,), "Wall Of Fire", "Has a wall of fire. Needs an item to pass. TBI.", (3,), 'TFE'),
