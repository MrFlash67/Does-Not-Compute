...
containerLocation(['TELNET FIRE EXTINGLISHER'], 2, 'You are in a supply room. You see a TELNET FIRE EXTINGLISHER. Better take both.', [-1, 1, -1, -1], 'Supply Room', 'Has stuff in it.', 'You are in a supply room. You see where a TELNET FIRE EXTINGLISHER and an APPLE PLOT TOKEN would be, if they were stil there.'),
