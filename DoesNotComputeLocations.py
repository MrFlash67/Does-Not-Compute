...
locs = [
Location(0, 'You are in a computer. A banana runs at you, then promptly fades away.', [1, -1, -1, -1], 'Starting room', 'Requires  5 uses of the \'go\' command'),
BlockedLocation(1, 'You are in a computer, north of where you were. There is a wall of fire just in front of you.', [-1, -1, 0, 2], "Wall Of Fire", "Has a wall of fire. Needs an item to pass. TBI.", [3,-1,0,2], 'TELNET FIRE EXTINGLISHER', 'You are in a computer, north of where you were. There is the charred remains of a wall of fire in front of you.'),
