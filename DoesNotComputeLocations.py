...
BlockedLocation(1, 'You are in a computer, north of that incident with the fading banana. There is a wall of fire to your north.', [-1, -1, 0, 2], "Wall Of Fire", "Has a wall of fire. Needs an item to pass. TBI.", [3,-1,0,2], 'TELNET FIRE EXTINGLISHER', 'You are in a computer, north of where you were. There is the charred remains of a wall of fire in front of you.'),
containerLocation(['TELNET FIRE EXTINGLISHER'], 2, 'You are in a supply room. You see a TELNET FIRE EXTINGLISHER.', [-1, 1, -1, -1], 'Supply Room', 'Has stuff in it.', 'You are in a supply room. You see where a TELNET FIRE EXTINGLISHER would be, if they were stil there.'),
